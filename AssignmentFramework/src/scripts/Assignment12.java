...
public class Assignment12 extends BaseClassChrome {
	...
	@Test
	public static void scenario12() throws Exception {
		...
		for(WebElement msg : errMsgs)
		{
			if(msg.isDisplayed())
			{
				...
				Reporter.log("Errer message is displayed and the message is : "+msg.getText(), true);
			}
			else
				//System.out.println("Error message is not being displayed");
				Reporter.log("Errer message is not being displayed", true);
		}
	}
}
